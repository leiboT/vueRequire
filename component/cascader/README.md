...
<div class="block">
  ...
  <sf-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></sf-cascader>
</div>
<div class="block">
...
```html
<sf-cascader :options="options"></sf-cascader>
...
:::demo
```html
<sf-cascader :options="options" clearable></sf-cascader>
...
```html
<sf-cascader :options="options" :show-all-levels="false"></sf-cascader>
...
```html
<sf-cascader :props="props"></sf-cascader>
...
```html
<sf-cascader-panel :options="options"></sf-cascader-panel>
